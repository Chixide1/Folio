    ...
    return (
      ...
      >
        <p>
          ...
          <span className="font-semibold text-card-foreground"> BSc in Computer Forensics and Cybersecurity.</span>
        </p>
        <p>
          ...
          <span className="font-semibold text-card-foreground"> C#, Typescript & Python </span>
          - ranging from a personal finance app to a file-sharing platform.
        </p>
        <p>
          Currently, I work as a <span className="font-semibold text-card-foreground"> 2nd Line IT Service Desk Analyst </span>
        ...
        <p>
          I thrive on solving problems, building impactful tools, and <span className="font-semibold text-card-foreground">continuously learning</span>.
